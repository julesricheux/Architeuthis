...
from architeuthis.numpy.determine_type import is_casadi_type
from architeuthis.numpy.arithmetic_dyadic import centered_mod as _centered_mod
from architeuthis.numpy.array import array, concatenate, reshape
    ...
    Args:
        ...
        *varargs: The spacing between the points of f. If a scalar, the spacing is assumed to be uniform in all
        ...
        period: The period of the data. If provided, the gradient is taken assuming the data "wraps around" at the period
            (i.e., modulo the period). See `architeuthis.numpy.diff()` for more information.
