...
from architeuthis.numpy.array import length, concatenate
...
def integrate_discrete_intervals(
    ...
    if method in ["forward_euler", "forward", "euler_forward", "left", "left_riemann"]:
        ...
        avg_f = (f1 - f3 + 3 * q3**2 * (f1 + f2) - 2 * q3 * (2 * f1 + f2)) / (
            6 * q3 * (q3 - 1)
        )
        ...
        avg_f = (f2 - f1 + 3 * q1**2 * (f2 + f3) - 2 * q1 * (2 * f2 + f3)) / (
            6 * q1 * (q1 - 1)
        )
    ...
    if method_endpoints == "lower_order":
        ...
        if method_endpoints == "simpson":
            if remaining_endpoint_intervals[0] != 0:
                ...
                avg_f = concatenate((avg_f_left_intervals, avg_f))
    ...
    if method in ["cubic", "cubic_spline"]:
        ...
        middle_intervals = (
            ...
            * (
                ...
                * (
                ...
                + dfm**2 * (s1 * s5 + s11 * s9 + s12 * s13 + s3 * s4 + s6 * s8)
                + dfm * dfp * (hm * hp * s5 - s18 - s19 - 2 * s20 * s3 - s23)
                + dfp**2 * (s0 * s5 + s11 * s16 + s13 * s17 + s14 * s3 + s15 * s8)
            )
        ...
        first_interval = (
            ...
            * (
                ...
                - h_f * hp_f * s5 * s7
                + hm_f * hp_f * s10 * s8
                - hm_f * s0 * s16 * s34 * (4 * df_f + s29)
                - 9 * hp_f * s0 * s21 * s28
                + s0 * s13 * s3
                + s0 * s14 * s5
                + s0 * s15 * s22 * (27 * s11 - 21 * s4 + s40)
                + s1 * s11 * s5
                + 4 * s1 * s13 * s8
                + s1 * s15 * s23 * (-12 * s28 - 14 * s4 + s41 + 9 * s9)
                + s1 * s19 * s39 * (s38 - s4 + s40)
                + 3 * s1 * s21 * s30 * (-dfp_f + s32)
                + s1 * s25 * s37 * (s10 + s13 + s17 - 7 * s4 + s42)
                + 6 * s1 * s26 * s33 * (dfm_f + dfp_f - s32)
                + s11 * s12 * s3
                + s11 * s18 * s20
                + s12 * s14 * s8
                + 6 * s12 * s16 * s30 * (df_f + s29)
                + s12 * s18 * s39 * (s13 + s38 - 9 * s4)
                + s12 * s22 * s23 * (s24 - 42 * s4 + s41 + s42 + 3 * s9)
                + 13 * s13 * s18 * s25
                + 12 * s13 * s22 * s26
                + s14 * s20 * s25
                + s15 * s16 * s17
                + s15 * s18 * s30 * (-7 * dfm_f + s31)
                - s15 * s25 * s36 * (-8 * dfm_f + s31)
                + s15 * s26 * s27
                + s16 * s23 * s24
                + s17 * s21 * s22
                - 4 * s18 * s23 * s33 * (7 * df_f + s35)
                - s19 * s22 * s30 * (dfp_f - s31 + s34)
                - s19 * s23 * s36 * (16 * df_f + s35)
                + s21 * s23 * s27
                + s22 * s25 * s33 * (-30 * df_f + 15 * dfm_f + s6)
                - s26 * s36 * s37 * (s32 + s35)
            )
        ...
        last_interval = (
            ...
            * (
                ...
                + hm_l * hp_l * s10 * s8
                - 9 * hm_l * s0 * s16 * s28
                - hp_l * s0 * s21 * s34 * (4 * df_l + s29)
                + s0 * s13 * s3
                + s0 * s14 * s6
                + s0 * s15 * s22 * (27 * s11 + s40 - 21 * s7)
                + s1 * s11 * s3
                + 4 * s1 * s14 * s8
                + 3 * s1 * s16 * s30 * (-dfm_l + s32)
                + s1 * s19 * s39 * (s38 + s40 - s7)
                + s1 * s22 * s23 * (-12 * s28 + s41 - 14 * s7 + 9 * s9)
                + s1 * s25 * s37 * (s10 + s14 + s17 + s42 - 7 * s7)
                + 6 * s1 * s26 * s33 * (dfm_l + dfp_l - s32)
                + s11 * s12 * s6
                + s11 * s18 * s20
                + s12 * s13 * s8
                + s12 * s15 * s23 * (s27 + s41 + s42 - 42 * s7 + 3 * s9)
                + s12 * s18 * s39 * (s14 + s38 - 9 * s7)
                + 6 * s12 * s21 * s30 * (df_l + s29)
                + s13 * s20 * s25
                + 12 * s14 * s15 * s26
                + 13 * s14 * s18 * s25
                + s15 * s16 * s17
                - s15 * s19 * s30 * (dfm_l - s31 + s34)
                + s15 * s25 * s33 * (-30 * df_l + 15 * dfp_l + s4)
                + s16 * s23 * s24
                + s17 * s21 * s22
                + s18 * s22 * s30 * (-7 * dfp_l + s31)
                - 4 * s18 * s23 * s33 * (7 * df_l + s35)
                - s19 * s23 * s36 * (16 * df_l + s35)
                + s21 * s23 * s27
                + s22 * s24 * s26
                - s22 * s25 * s36 * (-8 * dfp_l + s31)
                - s26 * s36 * s37 * (s32 + s35)
            )
        ...
        res_backward_simpson = (
            4 * (df * hm - dfm * h) ** 2 / (h * hm**2 * (h + hm) ** 2)
        )
        ...
        middle_intervals = (
            (a**2 + b**2) / 2 + 1e-100
        ) ** 0.5  # This is more accurate across all frequencies
        ...
        from architeuthis.numpy.calculus import gradient
        ...
        res = 4 * (dfdx1**2 + dfdx1 * dfdx2 + dfdx2**2) / h + 12 * df / h**2 * (
            df / h - dfdx1 - dfdx2
        )
...
if __name__ == "__main__":
    ...
    approx = integrate_discrete_intervals(
        f=np.gradient(f_vals, x_vals, n=2) ** 2,
        x=x_vals,
    )
    integral = np.sum(approx)
    ...
    f_interp = interpolate.InterpolatedUnivariateSpline(x=x, y=f, k=3)
    exact = integrate.quad(
