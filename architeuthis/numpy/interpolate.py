...
from architeuthis.numpy.array import array, zeros_like
from architeuthis.numpy.conditionals import where
from architeuthis.numpy.logicals import all, any, logical_or
