...
from architeuthis.modeling.interpolation import InterpolatedModel
...
class UnstructuredInterpolatedModel(InterpolatedModel):
    ...
    def __init__(
        ...
        Args:
            ...
            Also a dictionary. See architeuthis.InterpolatedModel for documentation on possible inputs here.
