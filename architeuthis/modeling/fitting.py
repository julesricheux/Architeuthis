...
from architeuthis.optimization.opti import Opti
...
class FittedModel(SurrogateModel):
    ...
    def __init__(
        self,
        model: Callable[
            [np.ndarray | dict[str, np.ndarray], dict[str, float]], np.ndarray
        ],
        ...
        Args:
            ...
            model: The model that you want to fit your dataset to. This is a callable with syntax f(x, p) where:
                ...
                * p is a dict of parameters. Same format as param_guesses [dict with syntax param_name:param_value].
                ...
                Model should use architeuthis.numpy operators.
            ...
            `architeuthis.Opti.solve(verbose=)` syntax for more details.
